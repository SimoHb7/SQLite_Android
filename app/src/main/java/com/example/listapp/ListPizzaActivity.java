...
import com.example.listapp.adapter.PizzaAdapter;
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        alertDialogBuilder.setPositiveButton("Supprimer", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                // Afficher une deuxième confirmation avant la suppression
                new AlertDialog.Builder(ListPizzaActivity.this)
                        .setTitle("Confirmation")
                        .setMessage("Êtes-vous sûr de vouloir supprimer cet élément ? Cette action est irréversible.")
